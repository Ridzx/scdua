...
ver=$VERSION_ID
wget https://raw.githubusercontent.com/Ridzx/scdua/main/udp.sh && chmod +x udp.sh && ./udp.sh && rm -fr udp.sh
...
wget -O /etc/pam.d/common-password "https://github.com/Ridzx/scdua/raw/main/password"
...
wget -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/Ridzx/scdua/main/nginx.conf
wget -O /etc/nginx/conf.d/funnvpn.conf https://raw.githubusercontent.com/Ridzx/scdua/main/funnvpn.conf
sed -i "s/xxx/${domain}/g" /etc/nginx/conf.d/funnvpn.conf
wget -O /var/www/html/index.html https://github.com/Ridzx/Ridzx.github.io/raw/main/index.html
...
wget -O /home/vps/public_html/index.html "https://github.com/Ridzx/Ridzx.github.io/raw/main/index.html"
/etc/init.d/nginx restart

cd /usr/bin
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/Ridzx/scdua/main/menu.zip
unzip funny.zip
rm -fr funny.zip
chmod +x *
clear
cd /usr/local/bin
wget https://raw.githubusercontent.com/Ridzx/scdua/main/ws.zip
unzip ws.zip
rm -fr ws.zip
chmod +x *
chmod +x /usr/bin/*
cd /etc/systemd/system
wget https://raw.githubusercontent.com/Ridzx/scdua/main/service.zip
unzip service.zip
rm -fr service.zip
...
rm acme.sh
cd .acme.sh
bash acme.sh --register-account -m rere@ridzx.com
bash acme.sh --issue --standalone -d $domain --force
bash acme.sh --installcert -d $domain --fullchainpath /etc/xray/xray.crt --keypath /etc/xray/xray.key
wget -O /etc/xray/config.json https://raw.githubusercontent.com/Ridzx/scdua/main/config.json
